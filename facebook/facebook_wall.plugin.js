	...
	$.fn.facebook_wall = function(options) {
		...
		options = $.extend({
			...
			text_labels: {
				...
				comments: {
					singular: 'visualizza altri % commenti',
					plural: 'visualizza altri % commenti'
				},
				like: 'Ti piace',
				comment: 'Commenti',
				share: 'Condividi',
                days: ['Lunedi', 'Marted&#236;', 'Mercoled&#236;', 'Gioved&#236;', 'Venerd&#236;', 'Sabato', 'Domenica'],
